...
static const char *fonts[]          = { "JetBrains Mono NL:style=Regular:style=Regular:pixelsize=12:antialias=true:autohint=true","JoyPixels:pixelsize=18:style=Regular:antialias=true:autohint=true"};
